...
public class MessageBuilder {
	...
	public MessageBuilder(int id, String alias) {
		this.id = id;
		this.alias = alias;
	}
	...
	public View generateMessage(LayoutInflater inflater, ViewGroup container) {
		...
		case REQUEST: 
	        ...
	        yes.setOnClickListener(new RequestClickListener(Global.ACCEPT, view));
	        no.setOnClickListener(new RequestClickListener(Global.DECLINE, view));
	        break;
		case ACCEPTED:
